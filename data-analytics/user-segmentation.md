...
![](https://docs.growingio.com/segmentation_v2/%20选择用户%20ID类型.png)
...
![](https://docs.growingio.com/segmentation_v2/事件的过滤.png)
...
![](https://docs.growingio.com/segmentation_v2/用户是.png)
...
![](https://docs.growingio.com/segmentation_v2/条件组和条件.png)
...
![](https://docs.growingio.com/segmentation_v2/上传登录用户%20ID%20（没有%20CS1）.png)

![](https://docs.growingio.com/segmentation_v2/上传登录用户入口（有CS1）.png)
...
#### **2.4.3 查看当前分群跟同周期全量用户的人数对比**

在分群人数每日变化视图下方为用户对比视图，您可以在该视图中查看当前分群与同周期全量用户的人数对比。

![](https://lh6.googleusercontent.com/I4vw4-IG2_WhmGHLjOWtER8RKRRJoSLSAhm5XC4T4Ax8QNc-vWlFREriSxhbYcSNW3UN595PNmHsZQdOG-Q-TU2ObJOGSTVGTAImLamwY6SV_spjzvxtn-n13l9MnxSmBKqBI-9B)
...
* 对比对象：与当前用户分群所选的目标用户一致（例如，图中分群的目标用户是”访问用户“，对比分群默认相应选择了“全部访问用户”）。
